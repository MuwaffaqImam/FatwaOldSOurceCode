...
{
    public class FatawaDefaultSetting : BaseEntity
    {
        ...
        public virtual ICollection<FatawaDefaultSettingTranslation> FatawaDefaultSettingTranslations { get; set; }
    }

    public class FatawaDefaultSettingTranslation : TranslateBase
    {
