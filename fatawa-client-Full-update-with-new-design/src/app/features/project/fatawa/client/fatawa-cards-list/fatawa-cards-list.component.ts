...
@Component({
    selector: 'app-fatawa-cards-list',
    templateUrl: './fatawa-cards-list.component.html',
    styleUrls: ['./fatawa-cards-list.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FatawaCardsListComponent implements OnInit {
    ...
    getFatawaDepartments() {
        return this.fatawaService.getDepartmentsByLevelId(2);
    }
