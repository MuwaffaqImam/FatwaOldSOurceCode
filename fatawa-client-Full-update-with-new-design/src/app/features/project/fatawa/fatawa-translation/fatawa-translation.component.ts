...
@Component({
    selector: 'app-fatawa-translation',
    templateUrl: './fatawa-translation.component.html',
    styleUrls: ['./fatawa-translation.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
})
export class FatawaTranslationComponent implements OnInit {
